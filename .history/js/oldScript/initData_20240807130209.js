import { DataStore } from "../oldData/DataStore.js";
import { Category } from "../oldData/Category.js";
import { Sale, SaleRender } from "../oldData/Sale.js";
...
if (!localStorageData) {
    ...
    //로컬 스토리지에 데이터가 있는데
    if (dataStore.map.size === 0 && dataStore.sales.length === 0) {
        //메모리가 빈 경우.
