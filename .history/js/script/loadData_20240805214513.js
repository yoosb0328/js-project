...
function requestData() {
    ...
    const data = DataStore.getInstance().loadFromLocalStorage();
    const categoryRender = new CategoryRender(data.categories);
    categoryRender.render();
    window.opener.postMessage({ type: "requestCategories", data: "" }, "*");
}
