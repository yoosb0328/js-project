        ...
        if (data) {
            ...
            if (parsedData.sales) {
                const category = this.categories.find(
                    (cat) => cat.code === parsedData.sales.category.code
                );
                return new Sale(
                    parsedData.sales.date,
                    category,
                    parsedData.sales.quantity,
                    parsedData.sales.price,
                    parsedData.sales.description
                );
            }
