...
function save(event) {
    ...
    switch (type) {
        ...
        case "sale":
            ...
            const dateNumber = `${yearSelect.value}-${monthSelect.value.padStart(
                2,
                "0"
            )}-${dateInput.value.padStart(2, "0")}`;
            const categoryCode = categoryInput.getAttribute("data-code");
