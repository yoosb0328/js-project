...
logStringDetails(dateNumber, "dateNumber");
logStringDetails(categoryCode, "categoryCode");
logStringDetails(quantity, "quantity");
logStringDetails(price, "price");
logStringDetails(description, "description");
logStringDetails(mode, "mode");
